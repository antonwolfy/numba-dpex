...
def sum_reduction_kernel(A, partial_sums):
    ...
    function.
    """
    local_id = numba_dppy.get_local_id(0)
    global_id = numba_dppy.get_global_id(0)
    group_size = numba_dppy.get_local_size(0)
    group_id = numba_dppy.get_group_id(0)

    local_sums = numba_dppy.local.array(64, int32)
